...
#define CE_LOW()        HAL_GPIO_WritePin     (SI_EN_GPIO_Port, SI_EN_Pin, GPIO_PIN_RESET)//拉低使能
#define CE_HIGH()       HAL_GPIO_WritePin     (SI_EN_GPIO_Port, SI_EN_Pin, GPIO_PIN_SET)  //拉高使能
//(2).SI24R1的地址宽度和有效数据宽度

#define TX_ADR_WIDTH    5  				    // 5位地址长度
#define TX_PLOAD_WIDTH  17  				// 17位有效数据长度(取决于发送数据的宽度)
